...
function usageZh(p) {
  return docShell({ eyebrow: `使用文档 · v${version}`, title: "从安装到第一次注入", lead: "这份指南覆盖当前已验收的 macOS + Codex 路径，以及模块导入、运行状态与常见问题。", toc: [["install","安装"],["product","目标应用"],["enable","启用模块"],["launch","启动与重启"],["status","理解状态"],["agent","Agent 集成"],["import","导入模块"],["data","文件与数据"],["troubleshooting","故障排查"]], body: `
